...
namespace NavyCOOLBox.Factories
{
	public class AssessmentManager
	{
		...
		/// <returns></returns>
		public static List<InputEntity> Search(string pFilter, string pOrderBy, int pageNumber, int pageSize, ref int pTotalRows)
		{

			var results = new List<InputEntity>();
		...
		public static InputEntity Get_AircraftDispatcherWrittenExam()
		{
...
- Applied Dispatching";
		...
		public static InputEntity Get_AircraftDispatcherPracticalExam()
		{
			//if publishing this, use the following and then set thisCTID to actual value to prevent duplicates
			string thisCTID = "ce-" + Guid.NewGuid().ToString().ToLower();
			//
...
- Abnormal and Emergency Procedures";
		...
		public static InputEntity Get_Sample1()
		{
