...
namespace NavyCOOLBox.Factories
{
	public class CredentialManager
	{
		...
		/// <returns></returns>
		public static List<SM.CredentialDTO> Search(string pFilter, string pOrderBy, int pageNumber, int pageSize, ref int pTotalRows )
		{

			var results = new List<SM.CredentialDTO>();
			results.Add( Get_AircraftDispatcher() );
			var credential = new SM.CredentialDTO() { CA_AgencyID = 1, CE_CertID = 1, CE_CertTitle = "Test Credential" };
