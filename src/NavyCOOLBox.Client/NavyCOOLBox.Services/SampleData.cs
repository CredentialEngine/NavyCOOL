...
using Solid.Models;
using OrgEntity = Solid.Models.AgencyDTO;
using AgencyDTO = NavyCOOLBox.Models.Agency;
using ARTTCredential = NavyCOOLBox.Models.ARTTCredential;
...
namespace NavyCOOLBox.Services
{
	public class SampleData
	{
		...
		public static OrgEntity Get_FAA2()
		{
			OrgEntity agency = new OrgEntity();
			//
			agency.CTID = FAA_CTID;
			agency.CA_AgencyName = "Federal Aviation Administration (FAA)";
			agency.CA_AgencyStreetAddress1 = "800 Independence Avenue SW";
		...
		public static ARTTCredential Get_AircraftDispatcher()
		{
			var faa = Get_FAA();

			ARTTCredential c = new ARTTCredential();
...
//			};
		...
		public static CredentialDTO Get_AircraftDispatcherAsDTO()
		{
			var faa = Get_FAA();
