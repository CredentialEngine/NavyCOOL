...
namespace COOLTool.Services.Models.Input
{
	...
	public class ARTTCredential
	{
		...
		// as discussed, this will be a list of Rating CTIDs
		public List<string> cred_Rating { get; set; } = new List<string>();

		// as discussed, this will be a list of actual O*NET Codes
		public List<string> cred_ONET { get; set; } = new List<string>();

		// list of acronymns, and URL separated by pipes for accrediting organizations
		public List<string> cred_AccreditedBy { get; set; } = new List<string>();

		// list of acronymns for sources of financial assistance
		public List<string> cred_FinancialAssistance { get; set; } = new List<string>();

		//CE_RenewalPeriod:
		//a string stating what the renewal period is. It could say “1 year” or “Lifetime”, etc.
		public string CE_RenewalPeriod { get; set; }

		public List<ConditionProfile> cred_ConditionProfiles { get; set; } = new List<ConditionProfile>();
	}
