...
using SM = COOLTool.Services.Models.Input;
...
namespace COOLTool.Services
{
	public class MappingHelpers
	{
		...
		public static List<RMI.OrganizationReference> MapToOrgReferences( List<SM.OrganizationReference> input )
		{
			List<RMI.OrganizationReference> output = new List<RMI.OrganizationReference>();
		...
		public static List<RMI.OrganizationReference> MapToOrgReferences(SM.OrganizationReference org)
		{
		...
		public static RMI.OrganizationReference MapToOrgReference(SM.OrganizationReference org)
		{
