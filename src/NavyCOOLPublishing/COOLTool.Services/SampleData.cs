...
using OrgRef = COOLTool.Services.Models.Input.OrganizationReference;
...
namespace COOLTool.Services
{
    public class SampleData
    {
		...
		public static OrgEntity Get_FAA()
		{
		...
		public static ARTTCredential Get_AircraftDispatcher_As_ARTT()
		{
			var faa = Get_FAA();
